...
dataavailable <- read_waterdata_ts_meta(monitoring_location_id = BLANK) #look to where we set parameters early in the script for this variable name
```
...
new_crs <- st_crs(32613)  # Use the appropriate EPSG code for your CRS. This is typically one of those pre-defined parameters that we would put at the beginning of the script with others (~line62). 
